  ...
  return (
    <header className="pd-top">
      <div className="pd-brand">
        <button style={buttonStyle()} aria-label="Toggle saved diagrams" onClick={onToggleSidebar}>☰</button>
        <h1>ProcessDraw</h1>
      ...
      <div className="pd-actions">
        ...
        <button style={buttonStyle()} aria-label="Help" onClick={onHelp}>?</button>
        ...
        {hasBlocks && finalized && <button style={buttonStyle("primary")} onClick={onExportPng}>PNG</button>}
        {hasBlocks && finalized && <button style={buttonStyle("purple")} onClick={onExportPdf}>PDF</button>}
        {notificationsBell}
        {isCloud && userButton}
      </div>
    </header>
